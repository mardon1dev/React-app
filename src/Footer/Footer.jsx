...
import Footerfasbook from './Footerfazbook.svg';
import Footertwter from './Footertwtter.svg';
import Footerinstagram from './Footerinstagram.svg';
                    ...
                    <div className="row gy-5">
                        ...
                        <div className="col-12 col-md-4 justify-content-center justify-content-md-between">
                            ...
                            <div className='d-flex align-items-center justify-content-center gap-3'>
                                <a className='text-decoration-none d-block contact__link' target='_blank' href="https://www.google.com/search?q=fasbook&oq=fasbook&aqs=chrome..69i57j46i10i131i199i433i465i512j0i10i433i512j0i10i512l6.5773j0j7&sourceid=chrome&ie=UTF-8"><img src={Footerfasbook} alt="Footerfasbook" /></a>
                                <a className='text-decoration-none d-block contact__link' target='_blank' href="https://twitter.com/?lang=ru"><img src={Footertwter} alt="Footerfasbook" /></a>
                                <a className='text-decoration-none d-block contact__link' target='_blank' href="https://www.instagram.com/"><img src={Footerinstagram} alt="Footerfasbook" /></a>
